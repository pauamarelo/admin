...
"use strict";angular.module("myApp").controller("partidasCtrl",function($scope,$http,config,toaster){var vm=this;function listar(){vm.isLoading=!0,$http.get(config.listarPartidas).then(function(response){response.data.status&&(vm.res=response.data,vm.partidas=response.data.data,vm.isLoading=!1)})}vm.dados={},vm.isLoading=!1,vm.isPostLoading=!1,vm.orderByField="-createdAt",vm.reverseSort=!1,vm.pageSize="10",vm.pagination={current:1},listar(),vm.openAdd=function(){vm.dados={},$("#modalAdd").modal("show")},vm.adicionar=function(d){vm.isPostLoading=!0;var objData={map:d.map,status:d.status,clan_home:{name:"PAU AMARELO",score:d.clan_home.score,players:[]},clan_away:{name:d.clan_away.name,score:d.clan_away.score,players:[]}};$http.post(config.partidas,objData).then(function(response){response.data.status?(toaster.success("Sucesso!",response.data.msg),listar(),$("#modalAdd").modal("hide")):toaster.error("Erro","Houve um erro."),vm.isPostLoading=!1})},vm.openEdit=function(d){vm.dados=d,vm.img={},$("#modalEdit").modal("show")},vm.editar=function(d){vm.isPostLoading=!0;var objData={map:d.map,status:d.status,clan_home:{name:d.clan_home.name,score:d.clan_home.score,players:d.clan_home.players},clan_away:{name:d.clan_away.name,score:d.clan_away.score,players:d.clan_away.players}};$http.put(config.partidas+"/"+d._id,objData).then(function(response){response.data.status?(toaster.success("Sucesso!",response.data.msg),listar(),$(".modal").modal("hide")):toaster.error("Erro","Houve um erro."),vm.isPostLoading=!1})},vm.delete=function(d){confirm("Você realmente deseja excluir este registro?")&&$http.delete(config.partidas+"/"+d._id).then(function(response){response.data.status?(toaster.success("Sucesso!",response.data.msg),listar()):toaster.error("Erro","Houve um erro.")})},vm.openPlayers=function(d,clan){vm.dados=d,vm.clan=clan,$("#modalPlayers").modal("show")}});
